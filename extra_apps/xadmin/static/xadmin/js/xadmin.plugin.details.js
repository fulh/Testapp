      ...
      click: function(e){
        ...
        if(!modal.length){
          modal = $('<div id="detail-modal-id" class="modal fade detail-modal" role="dialog"><div class="modal-dialog"><div class="modal-content">'+
            ...
            '<div class="modal-footer"><button class="btn btn-default" data-dismiss="modal" aria-hidden="true">'+gettext('关闭')+'</button>'+
            '<a class="btn btn-submit btn-primary edit-btn"><i class="fa fa-pencil"></i> '+gettext('编辑')+'</a></div></div></div></div>');
          $('body').append(modal);
        }
